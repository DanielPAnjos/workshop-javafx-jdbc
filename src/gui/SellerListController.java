...
public class SellerListController implements Initializable, DataChangeListener {
	...
	// Referências para os componentes da tela SellerList.fxml
	@FXML
	...
	// Princípio de dependência. Inversão de controle.
	...
	// Janela de diálogo recebendo com paramêtro quem é o stage que a criou.
...
//		}
	...
	// Cria um objeto específico responsável por instaciar os botões de atualização
	// em cada linha e já configurar o evento do botão.
	...
	//Vai criar um botão "remove" em cada linha e pra cada botão selecionado será chamado o método removeEntity
